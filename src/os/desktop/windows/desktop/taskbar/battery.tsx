...
const Battery = ({ pct, invert }: {pct?: string, invert?: boolean}) => {
  const btLevel = -1;
  ...
  return (
    <>
      <div className={`flex flex-col justify-center w-6 relative place-self-center dark:text-white ${invert ? "invert" : ""}`}>
